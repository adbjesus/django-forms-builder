...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'forms', ['UserEntry'])

        # Adding unique constraint on 'UserEntry', fields ['user', 'form']
        db.create_unique(u'forms_userentry', ['user_id', 'form_id'])

        # Adding field 'Form.anonymous_vote'
        db.add_column(u'forms_form', 'anonymous_vote',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'UserEntry', fields ['user', 'form']
        db.delete_unique(u'forms_userentry', ['user_id', 'form_id'])

        # Deleting model 'UserEntry'
        db.delete_table(u'forms_userentry')

        # Deleting field 'Form.anonymous_vote'
        db.delete_column(u'forms_form', 'anonymous_vote')
